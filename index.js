...
(function(exports) {
  ...
  var ToProp = function (toProp) {
      this.toProp = toProp;
  };
  var updateState = Data_Function_Uncurried.runFn2($foreign.updateState_);
  var toProp = function (dict) {
      return dict.toProp;
  };
  var stringToProp = new ToProp(Unsafe_Coerce.unsafeCoerce);
  ...
  exports["stringToProp"] = stringToProp;
  ...
  exports["mkComponent"] = $foreign.mkComponent;
...
(function(exports) {
  ...
  var slot = function ($34) {
      return VIEW(Widget.create($34));
  };
  var graft = Unsafe_Coerce.unsafeCoerce;
  var bifunctorGraft = new Data_Bifunctor.Bifunctor(function (f) {
      return function (g) {
          return unGraft(function (v) {
              return graft(new Graft(function ($36) {
                  return f(v.value0($36));
              }, function ($37) {
                  return g(v.value1($37));
              }, v.value2));
          });
      };
  });
  ...
  var runGraft = unGraft(function (v) {
      var go = function (v2) {
          ...
          throw new Error("Failed pattern match at Halogen.ReactNative.Core line 90, column 7 - line 90, column 27: " + [ v2.constructor.name ]);
      };
      return go(v.value2);
  });
  exports["VIEW"] = VIEW;
...
(function(exports) {
  ...
  var title = function ($15) {
      return prop("title")(ReactNative_Basic.toProp(ReactNative_Basic.stringToProp)($15));
  };
...
(function(exports) {
  ...
  var Halogen_ReactNative_Elements_Indexed = PS["Halogen.ReactNative.Elements.Indexed"];
      ...
      return function (component) {
          return function (input) {
              return function (outputQuery) {
                  ...
                  return Halogen_ReactNative_Core.slot(Halogen_Component.mkComponentSlot(p)(component)(input)(f)(outputQuery)(Data_Maybe.Just.create));
              };
          };
      };
  };
  exports["slot"] = slot;
})(PS["Halogen.ReactNative"] = PS["Halogen.ReactNative"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Unsafe_Coerce = PS["Unsafe.Coerce"];       
  var pressHandler = Unsafe_Coerce.unsafeCoerce;   
  ...
  var onPress = function ($2) {
      return handler("onPress")(pressHandler($2));
  };
  exports["handler"] = handler;
...
(function(exports) {
  ...
  var Halogen_Query = PS["Halogen.Query"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Halogen_ReactNative = PS["Halogen.ReactNative"];
  var Halogen_ReactNative_Elements = PS["Halogen.ReactNative.Elements"];
  var Halogen_ReactNative_Events = PS["Halogen.ReactNative.Events"];
  var Halogen_ReactNative_Properties = PS["Halogen.ReactNative.Properties"];
  var Prelude = PS["Prelude"];                 
  var ToggleOn = (function () {
      function ToggleOn(value0) {
          this.value0 = value0;
      };
      ToggleOn.create = function (value0) {
          return new ToggleOn(value0);
      };
      return ToggleOn;
  })();
  var $$Set = (function () {
  ...
  var HandleInner = (function () {
      function HandleInner(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleInner.create = function (value0) {
          return function (value1) {
              return new HandleInner(value0, value1);
          };
      };
      return HandleInner;
  })();
  var InnerInput = (function () {
      function InnerInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InnerInput.create = function (value0) {
          return function (value1) {
              return new InnerInput(value0, value1);
          };
      };
      return InnerInput;
  })();
  var CanSet = function (set) {
      this.set = set;
  };
  var set = function (dict) {
      return dict.set;
  };
  var liftQuery = function ($25) {
      return Inner.create(Data_Coyoneda.liftCoyoneda($25));
  };
  var factory = function (dictCanSet) {
      return function (innerComponent) {
          var render = function (state) {
              return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(ToggleOn.create)), Halogen_ReactNative_Properties.title("Check now") ]), Halogen_ReactNative_Elements.text(" Wrapper state: " + (function () {
                  if (state.on) {
                      return "on";
                  };
                  return "off";
              })()) ]), Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_($$Set.create)), Halogen_ReactNative_Properties.title("Set inner component to off") ]) ]), Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative.slot(Data_Unit.unit)(innerComponent)(state.input)(Halogen_HTML_Events.input(HandleInner.create)) ]) ]);
          };
          var $$eval = function (v) {
              if (v instanceof ToggleOn) {
              ...
              if (v instanceof $$Set) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(set(dictCanSet)(false))))(function (v1) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              };
              if (v instanceof Inner) {
                  return Data_Coyoneda.unCoyoneda(function (k) {
                      return function (q) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(q))(function (v1) {
                              if (v1 instanceof Data_Maybe.Nothing) {
                                  return Halogen_Query_HalogenM.halt("HOC inner component query failed (this should be impossible)");
                              };
                              if (v1 instanceof Data_Maybe.Just) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(k(v1.value0));
                              };
                              throw new Error("Failed pattern match at Example.HOC.HOC line 93, column 5 - line 96, column 27: " + [ v1.constructor.name ]);
                          });
                      };
                  })(v.value0);
              };
              if (v instanceof HandleInner) {
              ...
              throw new Error("Failed pattern match at Example.HOC.HOC line 84, column 3 - line 84, column 72: " + [ v.constructor.name ]);
          };
          return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
              ...
              "eval": $$eval,
              receiver: function (i) {
                  return Data_Maybe.Just.create(new InnerInput(i, Data_Unit.unit));
              }
          });
      };
  };
  ...
  exports["Inner"] = Inner;
  exports["HandleInner"] = HandleInner;
  exports["InnerInput"] = InnerInput;
  exports["liftQuery"] = liftQuery;
  exports["factory"] = factory;
})(PS["Example.HOC.HOC"] = PS["Example.HOC.HOC"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_HeytingAlgebra = PS["Data.HeytingAlgebra"];
  var Data_Maybe = PS["Data.Maybe"];
  var Example_HOC_HOC = PS["Example.HOC.HOC"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  ...
  var myButton = (function () {
      var render = function (state) {
          ...
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Properties.title(label), Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(Toggle.create)) ]), Halogen_ReactNative_Elements.text(label) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.HOC.Button line 57, column 10 - line 69, column 24: " + [ v.constructor.name ]);
      };
  ...
  var canSetQuery = new Example_HOC_HOC.CanSet($$Set.create);
  exports["Toggle"] = Toggle;
  exports["IsOn"] = IsOn;
  exports["Toggled"] = Toggled;
  exports["myButton"] = myButton;
  exports["canSetQuery"] = canSetQuery;
})(PS["Example.HOC.Button"] = PS["Example.HOC.Button"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Show = PS["Data.Show"];
  var Data_Unit = PS["Data.Unit"];
  var Example_HOC_Button = PS["Example.HOC.Button"];
  var Example_HOC_HOC = PS["Example.HOC.HOC"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  ...
  var CheckButtonState = (function () {
      function CheckButtonState(value0) {
          this.value0 = value0;
      };
      CheckButtonState.create = function (value0) {
          return new CheckButtonState(value0);
      };
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative.slot(ButtonSlot.value)(Example_HOC_HOC.factory(Example_HOC_Button.canSetQuery)(Example_HOC_Button.myButton))(Data_Unit.unit)(Halogen_HTML_Events.input(HandleButton.create)), Halogen_ReactNative_Elements.text("Button has been toggled " + (Data_Show.show(Data_Show.showInt)(state.toggleCount) + " time(s)")), Halogen_ReactNative_Elements.text("Last time I checked, the button was: " + (Data_Maybe.maybe("(not checked yet)")(function (v) {
              if (v) {
                  return "on";
              };
              return "off";
          })(state.buttonState) + ". ")), Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Properties.title("Check now"), Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(CheckButtonState.create)) ]) ]);
      };
      var initialState = {
          toggleCount: 0,
      ...
      var $$eval = function (v) {
          if (v instanceof HandleButton) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $15.toggleCount = st.toggleCount + 1 | 0;
                  return $15;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof CheckButtonState) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqButtonSlot)(ButtonSlot.value)(Example_HOC_HOC.liftQuery(Halogen_Query.request(Example_HOC_Button.IsOn.create))))(function (v1) {
          ...
          throw new Error("Failed pattern match at Example.HOC.Container line 60, column 10 - line 67, column 12: " + [ v.constructor.name ]);
      };
...
})(PS["Example.HOC.Container"] = PS["Example.HOC.Container"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var renderProp = function (driver) {
      return function (v) {
          ...
          if (v instanceof ReactNative_Basic.Handler) {
              return ReactNative_Basic.handlerProp(v.value0, function ($42) {
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(driver)(v.value1($42));
              });
          };
          if (v instanceof ReactNative_Basic.Nested) {
              return ReactNative_Basic.prop(v.value0, renderProp(driver)(v.value1));
          };
          throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 116, column 21 - line 120, column 66: " + [ v.constructor.name ]);
      };
  };
  var renderView = function (dictMonad) {
              ...
              return function (v) {
                  var go = function (v1) {
                      if (v1 instanceof Halogen_ReactNative_Core.Text) {
                          ...
                          return Control_Applicative.pure(dictMonad.Applicative0())(ReactNative_Basic.element(Halogen_ReactNative_Unsafe_Elements.textU)(props));
                      };
                      if (v1 instanceof Halogen_ReactNative_Core.Elem) {
                          return Control_Bind.bind(dictMonad.Bind1())(Data_Traversable.traverse(Data_Traversable.traversableArray)(dictMonad.Applicative0())(go)(v1.value2))(function (v2) {
                              var childProp = ReactNative_Basic.prop("children", v2);
                              ...
                              return Control_Applicative.pure(dictMonad.Applicative0())(ReactNative_Basic.element(v1.value0)(nativeProps));
                          });
                      };
                      if (v1 instanceof Halogen_ReactNative_Core.Grafted) {
                          return go(Halogen_ReactNative_Core.runGraft(v1.value0));
                      };
                      if (v1 instanceof Halogen_ReactNative_Core.Widget) {
                          return handleSlot(v1.value0);
                      };
                      throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 93, column 5 - line 93, column 69: " + [ v1.constructor.name ]);
                  };
                  return go(v);
              };
          };
  ...
  var getElement = Halogen_Aff_Driver_State.unRenderStateX(function (v) {
      if (v.node instanceof Data_Maybe.Just) {
          return v.node.value0;
      };
      if (v.node instanceof Data_Maybe.Nothing) {
          return ReactNative_Basic.element(v.rclass)(Data_Monoid.mempty(ReactNative_Basic.monoidNativeProps));
      };
      throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 79, column 3 - line 81, column 40: " + [ v.node.constructor.name ]);
  });
              ...
              return function (child) {
                  return function (view) {
                      return function (lastRender) {
                          return function __do() {
                              var v = renderView(Effect.monadEffect)(driver)(function ($43) {
                                  return Data_Functor.map(Effect.functorEffect)(getElement)(child($43));
                              })(view)();
                              if (lastRender instanceof Data_Maybe.Nothing) {
                                  var v1 = Effect_Ref.modify(function (v1) {
                                      return v1 + 1 | 0;
                                  })(keyRef)();
                                  var v2 = ReactNative_Basic.mkComponent(v);
                                  ReactNative_Basic.registerComponent(appName)(v2.rclass)();
                                  return {
                                      keyId: v1,
                                      rclass: v2.rclass,
                                      self: v2.self,
                              ...
                              if (lastRender instanceof Data_Maybe.Just) {
                                  ReactNative_Basic.updateState(v)(lastRender.value0.self)();
                                  return lastRender.value0;
                              };
                              throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 66, column 5 - line 74, column 29: " + [ lastRender.constructor.name ]);
                          };
                      };
                  };
              };
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  var Example_HOC_Container = PS["Example.HOC.Container"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_ReactNative_Driver = PS["Halogen.ReactNative.Driver"];
  var Prelude = PS["Prelude"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Halogen_ReactNative_Driver.runUI(Example_HOC_Container.component)(Data_Unit.unit)("examples"));
  exports["main"] = main;
})(PS["Example.HOC.Main"] = PS["Example.HOC.Main"] || {});
PS["Example.HOC.Main"].main();