      ...
      return function (dictMonad) {
          return function (s) {
              return Control_Bind.discard(Control_Bind.discardUnit)(dictMonad.Bind1())(Control_Applicative.pure(dictMonad.Applicative0())(Data_Unit.unit))(function () {
                  return $foreign.trace(dictDebugWarning)(s)(function (v) {
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text("My input value is:"), Halogen_ReactNative_Elements.text(Data_Show.show(Data_Show.showInt)(state)) ]);
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1 !== v.value0)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0)))(function () {
  ...
  exports["component"] = component;
})(PS["Example.Components.Inputs.Display"] = PS["Example.Components.Inputs.Display"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Maybe = PS["Data.Maybe"];
...
(function(exports) {
  ...
  var Data_Semiring = PS["Data.Semiring"];
  var Data_Void = PS["Data.Void"];
  var Example_Components_Inputs_Display = PS["Example.Components.Inputs.Display"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  ...
  var ordSlot = Data_Ord.ordInt;
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative.slot(1)(Example_Components_Inputs_Display.component)(state)(Data_Void.absurd), Halogen_ReactNative.slot(2)(Example_Components_Inputs_Display.component)(state * 2 | 0)(Data_Void.absurd), Halogen_ReactNative.slot(3)(Example_Components_Inputs_Display.component)(state * 3 | 0)(Data_Void.absurd), Halogen_ReactNative.slot(4)(Example_Components_Inputs_Display.component)(state * 10 | 0)(Data_Void.absurd), Halogen_ReactNative.slot(5)(Example_Components_Inputs_Display.component)(state * state | 0)(Data_Void.absurd) ]), Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(Increment.create)), Halogen_ReactNative_Properties.title("+1") ]), Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(Decrement.create)), Halogen_ReactNative_Properties.title("-1") ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Components.Inputs.Container line 61, column 10 - line 67, column 12: " + [ v.constructor.name ]);
      };
...
})(PS["Example.Components.Inputs.Container"] = PS["Example.Components.Inputs.Container"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var renderProp = function (driver) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 114, column 21 - line 118, column 66: " + [ v.constructor.name ]);
      };
  };
          ...
          return function (handleSlot) {
              return function (v) {
                  var go = function (v1) {
                      ...
                      throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 91, column 5 - line 91, column 69: " + [ v1.constructor.name ]);
                  };
                  return go(v);
              };
          };
                      ...
                      return function (lastRender) {
                          return function __do() {
                              ...
                              if (lastRender instanceof Data_Maybe.Nothing) {
                                  Debug_Trace.traceM(Debug_Trace.warn())(Effect.monadEffect)("No render state")();
                                  ...
                                  return {
                                      keyId: v1,
                                      node: Debug_Trace.spy(Debug_Trace.warn())("node")(v),
                                      updateView: v2
                                  };
                              };
                              if (lastRender instanceof Data_Maybe.Just) {
                                  Debug_Trace.traceM(Debug_Trace.warn())(Effect.monadEffect)("has Render state")();
                              ...
                              throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 66, column 5 - line 75, column 85: " + [ lastRender.constructor.name ]);
                          };
                      };
                  };
              };
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  var Example_Components_Inputs_Container = PS["Example.Components.Inputs.Container"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_ReactNative_Driver = PS["Halogen.ReactNative.Driver"];
  var Prelude = PS["Prelude"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Halogen_ReactNative_Driver.runUI(Example_Components_Inputs_Container.component)(Data_Unit.unit)("examples"));
  exports["main"] = main;
})(PS["Example.Components.Inputs.Main"] = PS["Example.Components.Inputs.Main"] || {});
PS["Example.Components.Inputs.Main"].main();