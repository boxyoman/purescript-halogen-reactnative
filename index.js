...
(function(exports) {
  ...
  var booleanToProp = new ToProp(Unsafe_Coerce.unsafeCoerce);
  ...
  exports["booleanToProp"] = booleanToProp;
...
(function(exports) {
  ...
  var disabled = function ($27) {
      return prop("disabled")(ReactNative_Basic.toProp(ReactNative_Basic.booleanToProp)($27));
  };
  exports["IProp"] = IProp;
  exports["prop"] = prop;
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text(""), Halogen_ReactNative_Elements.text("Lookup GitHub user"), Halogen_ReactNative_Elements.text(""), Halogen_ReactNative_Elements.text("Enter username:"), Halogen_ReactNative_Elements.textInput([ Halogen_ReactNative_Properties.value(state.username), Halogen_ReactNative_Events.onChangeText(Halogen_HTML_Events.input(SetUsername.create)) ])([  ]), Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Properties.title("Fetch Info"), Halogen_ReactNative_Properties.disabled(state.loading), Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(MakeRequest.create)) ]), Halogen_ReactNative_Elements.view([  ])((function () {
              if (state.result instanceof Data_Maybe.Nothing) {
                  return [  ];
              };
              if (state.result instanceof Data_Maybe.Just) {
                  return [ Halogen_ReactNative_Elements.text("response:"), Halogen_ReactNative_Elements.text(state.result.value0) ];
              };
              throw new Error("Failed pattern match at Example.Ajax.Component line 58, column 11 - line 63, column 16: " + [ state.result.constructor.name ]);
          })()) ]);
      };
      var initialState = {
          loading: false,
      ...
      var $$eval = function (v) {
          if (v instanceof SetUsername) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $10.username = v.value0;
                  $10.result = Data_Maybe.Nothing.value;
                  return $10;
              }))(function () {
          ...
          if (v instanceof MakeRequest) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.string)("https://api.github.com/users/" + v1)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $20.loading = false;
                              $20.result = new Data_Maybe.Just(v2.response);
                              return $20;
                          }))(function () {
          ...
          throw new Error("Failed pattern match at Example.Ajax.Component line 68, column 10 - line 77, column 12: " + [ v.constructor.name ]);
      };
  ...
  exports["component"] = component;
})(PS["Example.Ajax.Component"] = PS["Example.Ajax.Component"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  var Example_Ajax_Component = PS["Example.Ajax.Component"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_ReactNative_Driver = PS["Halogen.ReactNative.Driver"];
  var Prelude = PS["Prelude"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Halogen_ReactNative_Driver.runUI(Example_Ajax_Component.component)(Data_Unit.unit)("examples"));
  exports["main"] = main;
})(PS["Example.Ajax.Main"] = PS["Example.Ajax.Main"] || {});
PS["Example.Ajax.Main"].main();