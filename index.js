...
(function(exports) {
  ...
  var myButton = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Container.Button line 48, column 10 - line 57, column 24: " + [ v.constructor.name ]);
      };
...
})(PS["Example.Container.Button"] = PS["Example.Container.Button"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Show = PS["Data.Show"];
  var Data_Unit = PS["Data.Unit"];
  var Example_Container_Button = PS["Example.Container.Button"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  var Halogen_Query = PS["Halogen.Query"];
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof CheckButtonState) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqButtonSlot)(ButtonSlot.value)(Halogen_Query.request(Example_Container_Button.IsOn.create)))(function (v1) {
          ...
          throw new Error("Failed pattern match at Example.Container.Container line 58, column 10 - line 65, column 12: " + [ v.constructor.name ]);
      };
...
})(PS["Example.Container.Container"] = PS["Example.Container.Container"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  var Example_Container_Container = PS["Example.Container.Container"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_ReactNative_Driver = PS["Halogen.ReactNative.Driver"];
  var Prelude = PS["Prelude"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Halogen_ReactNative_Driver.runUI(Example_Container_Container.component)(Data_Unit.unit)("examples"));
  exports["main"] = main;
})(PS["Example.Components.Main"] = PS["Example.Components.Main"] || {});
PS["Example.Components.Main"].main();