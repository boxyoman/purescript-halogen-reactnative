...
(function(exports) {
  ...
  var value = function ($16) {
      return prop("value")(ReactNative_Basic.toProp(ReactNative_Basic.stringToProp)($16));
  };
...
(function(exports) {
  ...
  exports["textInputU"] = $foreign.textInputU;
})(PS["Halogen.ReactNative.Unsafe.Elements"] = PS["Halogen.ReactNative.Unsafe.Elements"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var textInput = element(Halogen_ReactNative_Unsafe_Elements.textInputU);
          ...
          return function (component) {
              return function (input) {
                  return function (outputQuery) {
                      ...
                      return Halogen_ReactNative_Core.slot(Halogen_Component.mkComponentSlot(Halogen_Component_ChildPath.injSlot(i)(p))(component)(input)(f)(outputQuery)(pq));
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var changeTextHandler = Unsafe_Coerce.unsafeCoerce;
  var onChangeText = function ($12) {
      return handler("onChangeText")(changeTextHandler($12));
  };
  exports["handler"] = handler;
  exports["pressHandler"] = pressHandler;
  exports["changeTextHandler"] = changeTextHandler;
...
(function(exports) {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Container.MultiType.ComponentA line 47, column 10 - line 53, column 24: " + [ v.constructor.name ]);
      };
  ...
  exports["component"] = component;
})(PS["Example.Container.MultiType.ComponentA"] = PS["Example.Container.MultiType.ComponentA"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text("Current Value: " + Data_Show.show(Data_Show.showInt)(state)), Halogen_ReactNative_Elements.button([ Halogen_ReactNative_Properties.title("Increment"), Halogen_ReactNative_Events.onPress(Halogen_HTML_Events.input_(Increment.create)) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Container.MultiType.ComponentB line 44, column 10 - line 50, column 24: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_ReactNative_Core.bifunctorVIEW)({
  ...
  exports["component"] = component;
})(PS["Example.Container.MultiType.ComponentB"] = PS["Example.Container.MultiType.ComponentB"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text("What do you have to say?"), Halogen_ReactNative_Elements.textInput([ Halogen_ReactNative_Properties.value(state), Halogen_ReactNative_Events.onChangeText(Halogen_HTML_Events.input(HandleInput.create)) ])([  ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Container.MultiType.ComponentC line 44, column 10 - line 50, column 24: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_ReactNative_Core.bifunctorVIEW)({
  ...
  exports["component"] = component;
})(PS["Example.Container.MultiType.ComponentC"] = PS["Example.Container.MultiType.ComponentC"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Unit = PS["Data.Unit"];
  var Data_Void = PS["Data.Void"];
  var Example_Container_MultiType_ComponentA = PS["Example.Container.MultiType.ComponentA"];
  var Example_Container_MultiType_ComponentB = PS["Example.Container.MultiType.ComponentB"];
  var Example_Container_MultiType_ComponentC = PS["Example.Container.MultiType.ComponentC"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_Component_ChildPath = PS["Halogen.Component.ChildPath"];
  var Halogen_Query = PS["Halogen.Query"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text(""), Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text("Compnent A"), Halogen_ReactNative["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Example_Container_MultiType_ComponentA.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_ReactNative_Elements.text(""), Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text("Compnent B"), Halogen_ReactNative["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Example_Container_MultiType_ComponentB.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_ReactNative_Elements.text(""), Halogen_ReactNative_Elements.view([  ])([ Halogen_ReactNative_Elements.text("Compnent C"), Halogen_ReactNative["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Example_Container_MultiType_ComponentC.component)(Data_Unit.unit)(Data_Void.absurd) ]) ]);
      };
      var initialState = {
  ...
  exports["component"] = component;
})(PS["Example.Container.MultiType.Container"] = PS["Example.Container.MultiType.Container"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var renderProp = function (driver) {
      return function (v) {
          ...
          if (v instanceof ReactNative_Basic.Handler) {
              return ReactNative_Basic.handlerProp(v.value0, function ($37) {
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(driver)(v.value1($37));
              });
          };
          if (v instanceof ReactNative_Basic.Nested) {
              return ReactNative_Basic.prop(v.value0, renderProp(driver)(v.value1));
          };
          throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 111, column 21 - line 115, column 66: " + [ v.constructor.name ]);
      };
  };
          ...
          return function (handleSlot) {
              return function (v) {
                  var go = function (v1) {
                      ...
                      throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 88, column 5 - line 88, column 69: " + [ v1.constructor.name ]);
                  };
                  return go(v);
              };
          };
              ...
              return function (child) {
                  return function (view) {
                      return function (lastRender) {
                          return function __do() {
                              var v = renderView(Effect.monadEffect)(driver)(function ($38) {
                                  return Data_Functor.map(Effect.functorEffect)(getElement)(child($38));
                              })(view)();
                              if (lastRender instanceof Data_Maybe.Nothing) {
                                  var v1 = Effect_Ref.modify(function (v1) {
                                      return v1 + 1 | 0;
                                  })(keyRef)();
                                  var v2 = ReactNative_Basic.registerComponent(appName)(v)();
                                  return {
                                      keyId: v1,
                                      node: v,
                                      updateView: v2
                              ...
                              if (lastRender instanceof Data_Maybe.Just) {
                                  lastRender.value0.updateView(v)();
                                  return {
                                      keyId: lastRender.value0.keyId,
                                      node: v,
                                      updateView: lastRender.value0.updateView
                                  };
                              };
                              throw new Error("Failed pattern match at Halogen.ReactNative.Driver line 65, column 5 - line 72, column 85: " + [ lastRender.constructor.name ]);
                          };
                      };
                  };
              };
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  var Example_Container_MultiType_Container = PS["Example.Container.MultiType.Container"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_ReactNative_Driver = PS["Halogen.ReactNative.Driver"];
  var Prelude = PS["Prelude"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Halogen_ReactNative_Driver.runUI(Example_Container_MultiType_Container.component)(Data_Unit.unit)("examples"));
  exports["main"] = main;
})(PS["Example.Components.MultiType.Main"] = PS["Example.Components.MultiType.Main"] || {});
PS["Example.Components.MultiType.Main"].main();